...
test("unfinished browser work keeps long budgets while completed answers settle promptly", () => {
  ...
  expect(CHATGPT_CONTEXT_UPLOAD_TIMEOUT_MS).toBe(1_200_000);
  expect(browserStageTimeouts.send).toBe(CHATGPT_CONTEXT_UPLOAD_TIMEOUT_MS);
