...
const en = {
  ...
  contextLengthBody: "Default keeps this ChatGPT Web route's current budget. 512K and 1M use six staged context uploads. Restart Codex after changing it.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  contextLength: "上下文长度",
  contextLengthBody: "默认会保留该 ChatGPT Web 路由当前的上下文预算。512K 和 1M 会固定分成 6 段上传上下文。修改后请重启 Codex。",
  contextDefault: "默认",
...
const ja: Record<keyof typeof en, string> = {
  ...
  contextLengthBody: "Default はこの ChatGPT Web ルートの現在の予算を維持します。512K と 1M はコンテキストを 6 分割して送信します。変更後は Codex を再起動してください。",
  contextDefault: "Default",
...
const ko: Record<keyof typeof en, string> = {
  ...
  contextLengthBody: "Default는 이 ChatGPT Web 경로의 현재 예산을 유지합니다. 512K와 1M은 컨텍스트를 6단계로 나누어 전송합니다. 변경 후 Codex를 다시 시작하세요.",
  contextDefault: "Default",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  contextLength: "上下文長度",
  contextLengthBody: "預設會保留此 ChatGPT Web 路由目前的上下文預算。512K 與 1M 會固定分成 6 段上傳上下文。變更後請重新啟動 Codex。",
  contextDefault: "預設",
