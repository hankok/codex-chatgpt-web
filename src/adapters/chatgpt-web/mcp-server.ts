...
// Large staged-context turns can keep ChatGPT waiting on a native tool well beyond the former
// two-minute bridge budget. Keep the MCP-side invocation alive for the same 20-minute ceiling used
// by staged browser sends; an explicit turn TTL can still shorten this per-call budget below.
export const CHATGPT_WEB_MCP_INVOCATION_TIMEOUT_MS = 1_200_000;
